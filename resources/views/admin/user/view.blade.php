            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.user.add') }}" class="brn btn-success btn-sm">New User</a>
                </div>
              </div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                  ...
                  @foreach($users as $key => $val)
                    <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                      ...
                      <td class="p-1 text-capitalize">{{ $val->name }}<br>{{ $val->email }}</td>
                      <td class="p-1 text-capitalize">{{ $val->type }}</td>
                      <td class="p-1 text-capitalize">{{ $val->mobile_no }}</td>
                      ...
                      <td class="center hidden-phone p-1" width="100">
                            <a href="{{ route('admin.user.edit', $val->id) }}" class="btn btn-sm btn-success"> <i
